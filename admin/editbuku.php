...
<body>
    ...
    <div class="container">
        ...
        <form action="updatebuku.php" method="post" name="form1" class="tulis" enctype="multipart/form-data">
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="judul" value="<?php echo $data['judul'] ?>" placeholder="Judul Buku">
                <label for="floatingPassword">Judul</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="penulis" value="<?php echo $data['penulis'] ?>" placeholder="Penulis">
                <label for="floatingPassword">Penulis</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="th_terbit" value="<?php echo $data['th_terbit'] ?>" placeholder="Tahun Rilis">
                <label for="floatingPassword">Tahun Rilis</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="genre" value="<?php echo $data['genre'] ?>" placeholder="Genre">
                <label for="floatingPassword">Genre</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="jumlah_halaman" value="<?php echo $data['jumlah_halaman'] ?>" placeholder="Jumlah Halaman">
                <label for="floatingPassword">Jumlah Halaman</label>
            </div>
            <div class="form-floating">
                <input type="file" class="form-control" id="floatingPassword" name="nama_file" value="<?= $data['gambar']?>" placeholder="Sampul">
                <label for="floatingPassword">Foto Sampul</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingPassword" name="link_buku" value="<?php echo $data['link_buku'] ?>" placeholder="Link">
